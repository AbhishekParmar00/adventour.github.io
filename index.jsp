...
<%
    ...
    try {
        ...
        try {
                ...
                int count=0;
                String sql1="Select count from visitcount";
                
                PreparedStatement pts1=con1.prepareStatement(sql1);
                ...
                String sql2="update visitcount set count=?";
                
                PreparedStatement pts2=con1.prepareStatement(sql2);
                pts2.setInt(1,count);
